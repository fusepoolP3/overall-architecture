...
String similarity metrics: Levenshtein, Jaccard, Q-grams  
String similarity non-metric: Jaro-Winkler  

Similarity measures can be further divided in character-based, token-based measures.  
