...
A brute force approach to the task will result in a number of comparisons equal to the Cartesian product of the two data sets.
...
* Parallelization of compaisons: GPUs, Map/Reduce (SILK),(block partition and use a thread for each similarity function ?)
